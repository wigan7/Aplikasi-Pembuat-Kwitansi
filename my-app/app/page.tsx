      ...
      <main className="main-content">
        ...
        <section className="templates-section">
          ...
          <div className="grid" ref={containerRef}>
            <Link href="/mbangsari-net-mukiran" className="card">
              <div className="card-icon">ISP</div>
              <h3 className="card-title">Mbangsari Net Mukiran</h3>
              <p className="card-desc">Pembuat kwitansi pembayaran internet ISP Mbangsari Net Cabang Mukiran dengan tampilan struk seperti bukti pembayaran.</p>
